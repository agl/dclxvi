# File:   dclxvi-20110718/fp2e_parallel_coeffmul.s
...
# qhasm: 0mysp = &mystack
# asm 1: leaq <mystack=stack6144#1,>0mysp=int64#4
...
# qhasm: 0ab0 = *(int128 *)(op1 + 0)
# asm 1: movdqa 0(<op1=int64#2),>0ab0=int6464#1
# asm 2: movdqa 0(<op1=%rsi),>0ab0=%xmm0
movdqa 0(%rsi),%xmm0
...
# qhasm: float6464 0t0 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t0=int6464#2
# asm 2: mulpd 0(<op2=%rdx),<0t0=%xmm1
mulpd 0(%rdx),%xmm1
...
# qhasm: float6464 0t1 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t1=int6464#3
# asm 2: mulpd 16(<op2=%rdx),<0t1=%xmm2
mulpd 16(%rdx),%xmm2
...
# qhasm: float6464 0t2 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t2=int6464#4
# asm 2: mulpd 32(<op2=%rdx),<0t2=%xmm3
mulpd 32(%rdx),%xmm3
...
# qhasm: float6464 0t3 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t3=int6464#5
# asm 2: mulpd 48(<op2=%rdx),<0t3=%xmm4
mulpd 48(%rdx),%xmm4
...
# qhasm: float6464 0t4 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t4=int6464#6
# asm 2: mulpd 64(<op2=%rdx),<0t4=%xmm5
mulpd 64(%rdx),%xmm5
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t5=int6464#7
# asm 2: mulpd 80(<op2=%rdx),<0t5=%xmm6
mulpd 80(%rdx),%xmm6
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t6=int6464#8
# asm 2: mulpd 96(<op2=%rdx),<0t6=%xmm7
mulpd 96(%rdx),%xmm7
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<0t7=int6464#9
# asm 2: mulpd 112(<op2=%rdx),<0t7=%xmm8
mulpd 112(%rdx),%xmm8
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<0t8=int6464#10
# asm 2: mulpd 128(<op2=%rdx),<0t8=%xmm9
mulpd 128(%rdx),%xmm9
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<0t9=int6464#11
# asm 2: mulpd 144(<op2=%rdx),<0t9=%xmm10
mulpd 144(%rdx),%xmm10
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<0t10=int6464#12
# asm 2: mulpd 160(<op2=%rdx),<0t10=%xmm11
mulpd 160(%rdx),%xmm11
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<0t11=int6464#1
# asm 2: mulpd 176(<op2=%rdx),<0t11=%xmm0
mulpd 176(%rdx),%xmm0
...
# qhasm: *(int128 *)(0mysp + 0) = 0r0
# asm 1: movdqa <0r0=int6464#2,0(<0mysp=int64#4)
# asm 2: movdqa <0r0=%xmm1,0(<0mysp=%rcx)
movdqa %xmm1,0(%rcx)

# qhasm: 0ab1 = *(int128 *)(op1 + 16)
# asm 1: movdqa 16(<op1=int64#2),>0ab1=int6464#2
# asm 2: movdqa 16(<op1=%rsi),>0ab1=%xmm1
movdqa 16(%rsi),%xmm1
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab1six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab1six=%xmm12
...
# qhasm: float6464 0t1 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t1=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t1=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t7=int6464#2
# asm 2: mulpd 96(<op2=%rdx),<0t7=%xmm1
mulpd 96(%rdx),%xmm1
...
# qhasm: float6464 0t2 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t2=int6464#2
# asm 2: mulpd 16(<op2=%rdx),<0t2=%xmm1
mulpd 16(%rdx),%xmm1
...
# qhasm: float6464 0t3 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t3=int6464#2
# asm 2: mulpd 32(<op2=%rdx),<0t3=%xmm1
mulpd 32(%rdx),%xmm1
...
# qhasm: float6464 0t4 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t4=int6464#2
# asm 2: mulpd 48(<op2=%rdx),<0t4=%xmm1
mulpd 48(%rdx),%xmm1
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t5=int6464#2
# asm 2: mulpd 64(<op2=%rdx),<0t5=%xmm1
mulpd 64(%rdx),%xmm1
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t6=int6464#2
# asm 2: mulpd 80(<op2=%rdx),<0t6=%xmm1
mulpd 80(%rdx),%xmm1
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<0t8=int6464#2
# asm 2: mulpd 112(<op2=%rdx),<0t8=%xmm1
mulpd 112(%rdx),%xmm1
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<0t9=int6464#2
# asm 2: mulpd 128(<op2=%rdx),<0t9=%xmm1
mulpd 128(%rdx),%xmm1
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<0t10=int6464#2
# asm 2: mulpd 144(<op2=%rdx),<0t10=%xmm1
mulpd 144(%rdx),%xmm1
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<0t11=int6464#2
# asm 2: mulpd 160(<op2=%rdx),<0t11=%xmm1
mulpd 160(%rdx),%xmm1
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t12=int6464#2
# asm 2: mulpd 176(<op2=%rdx),<1t12=%xmm1
mulpd 176(%rdx),%xmm1
...
# qhasm: *(int128 *)(0mysp + 16) = 0r1
# asm 1: movdqa <0r1=int6464#3,16(<0mysp=int64#4)
# asm 2: movdqa <0r1=%xmm2,16(<0mysp=%rcx)
movdqa %xmm2,16(%rcx)

# qhasm: 0ab2 = *(int128 *)(op1 + 32)
# asm 1: movdqa 32(<op1=int64#2),>0ab2=int6464#3
# asm 2: movdqa 32(<op1=%rsi),>0ab2=%xmm2
movdqa 32(%rsi),%xmm2
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab2six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab2six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t2 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t2=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t2=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t7=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<0t7=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t8=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<0t8=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t13=int6464#3
# asm 2: mulpd 176(<op2=%rdx),<1t13=%xmm2
mulpd 176(%rdx),%xmm2
...
# qhasm: float6464 0t3 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t3=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t3=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 0t4 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t4=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t4=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t5=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<0t5=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t6=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<0t6=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<0t9=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<0t10=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<0t11=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t12=int6464#13
# asm 2: mulpd 160(<op2=%rdx),<1t12=%xmm12
mulpd 160(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 32) = 0r2
# asm 1: movdqa <0r2=int6464#4,32(<0mysp=int64#4)
# asm 2: movdqa <0r2=%xmm3,32(<0mysp=%rcx)
movdqa %xmm3,32(%rcx)

# qhasm: 0ab3 = *(int128 *)(op1 + 48)
# asm 1: movdqa 48(<op1=int64#2),>0ab3=int6464#4
# asm 2: movdqa 48(<op1=%rsi),>0ab3=%xmm3
movdqa 48(%rsi),%xmm3
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab3six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab3six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t3 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t3=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t3=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t7=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<0t7=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t8=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<0t8=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<0t9=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t13=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t14=int6464#4
# asm 2: mulpd 176(<op2=%rdx),<1t14=%xmm3
mulpd 176(%rdx),%xmm3
...
# qhasm: float6464 0t4 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t4=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t4=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t5=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t5=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t6=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<0t6=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<0t10=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<0t11=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t12=int6464#13
# asm 2: mulpd 144(<op2=%rdx),<1t12=%xmm12
mulpd 144(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 48) = 0r3
# asm 1: movdqa <0r3=int6464#5,48(<0mysp=int64#4)
# asm 2: movdqa <0r3=%xmm4,48(<0mysp=%rcx)
movdqa %xmm4,48(%rcx)

# qhasm: 0ab4 = *(int128 *)(op1 + 64)
# asm 1: movdqa 64(<op1=int64#2),>0ab4=int6464#5
# asm 2: movdqa 64(<op1=%rsi),>0ab4=%xmm4
movdqa 64(%rsi),%xmm4
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab4six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab4six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t4 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t4=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t4=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t7=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<0t7=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t8=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<0t8=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<0t9=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<0t10=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<1t13=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t14=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t15=int6464#5
# asm 2: mulpd 176(<op2=%rdx),<1t15=%xmm4
mulpd 176(%rdx),%xmm4
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t5=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t5=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t6=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t6=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<0t11=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t12=int6464#13
# asm 2: mulpd 128(<op2=%rdx),<1t12=%xmm12
mulpd 128(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 64) = 0r4
# asm 1: movdqa <0r4=int6464#6,64(<0mysp=int64#4)
# asm 2: movdqa <0r4=%xmm5,64(<0mysp=%rcx)
movdqa %xmm5,64(%rcx)

# qhasm: 0ab5 = *(int128 *)(op1 + 80)
# asm 1: movdqa 80(<op1=int64#2),>0ab5=int6464#6
# asm 2: movdqa 80(<op1=%rsi),>0ab5=%xmm5
movdqa 80(%rsi),%xmm5
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab5six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab5six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t5 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t5=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t5=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t7=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t7=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t8=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<0t8=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<0t9=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<0t10=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<0t11=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<1t13=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<1t14=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t15=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t15=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t16=int6464#6
# asm 2: mulpd 176(<op2=%rdx),<1t16=%xmm5
mulpd 176(%rdx),%xmm5
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t6=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t6=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t12=int6464#13
# asm 2: mulpd 112(<op2=%rdx),<1t12=%xmm12
mulpd 112(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 80) = 0r5
# asm 1: movdqa <0r5=int6464#7,80(<0mysp=int64#4)
# asm 2: movdqa <0r5=%xmm6,80(<0mysp=%rcx)
movdqa %xmm6,80(%rcx)

# qhasm: 0ab6 = *(int128 *)(op1 + 96)
# asm 1: movdqa 96(<op1=int64#2),>0ab6=int6464#7
# asm 2: movdqa 96(<op1=%rsi),>0ab6=%xmm6
movdqa 96(%rsi),%xmm6
...
# qhasm: float6464 0t6 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t6=int6464#13
# asm 2: mulpd 0(<op2=%rdx),<0t6=%xmm12
mulpd 0(%rdx),%xmm12
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t7=int6464#13
# asm 2: mulpd 16(<op2=%rdx),<0t7=%xmm12
mulpd 16(%rdx),%xmm12
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t8=int6464#13
# asm 2: mulpd 32(<op2=%rdx),<0t8=%xmm12
mulpd 32(%rdx),%xmm12
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t9=int6464#13
# asm 2: mulpd 48(<op2=%rdx),<0t9=%xmm12
mulpd 48(%rdx),%xmm12
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t10=int6464#13
# asm 2: mulpd 64(<op2=%rdx),<0t10=%xmm12
mulpd 64(%rdx),%xmm12
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<0t11=int6464#13
# asm 2: mulpd 80(<op2=%rdx),<0t11=%xmm12
mulpd 80(%rdx),%xmm12
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t12=int6464#13
# asm 2: mulpd 96(<op2=%rdx),<1t12=%xmm12
mulpd 96(%rdx),%xmm12
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t13=int6464#13
# asm 2: mulpd 112(<op2=%rdx),<1t13=%xmm12
mulpd 112(%rdx),%xmm12
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t14=int6464#13
# asm 2: mulpd 128(<op2=%rdx),<1t14=%xmm12
mulpd 128(%rdx),%xmm12
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t15=int6464#13
# asm 2: mulpd 144(<op2=%rdx),<1t15=%xmm12
mulpd 144(%rdx),%xmm12
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t16=int6464#13
# asm 2: mulpd 160(<op2=%rdx),<1t16=%xmm12
mulpd 160(%rdx),%xmm12
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t17=int6464#7
# asm 2: mulpd 176(<op2=%rdx),<1t17=%xmm6
mulpd 176(%rdx),%xmm6
...
# qhasm: *(int128 *)(0mysp + 96) = 0r6
# asm 1: movdqa <0r6=int6464#8,96(<0mysp=int64#4)
# asm 2: movdqa <0r6=%xmm7,96(<0mysp=%rcx)
movdqa %xmm7,96(%rcx)

# qhasm: 0ab7 = *(int128 *)(op1 + 112)
# asm 1: movdqa 112(<op1=int64#2),>0ab7=int6464#8
# asm 2: movdqa 112(<op1=%rsi),>0ab7=%xmm7
movdqa 112(%rsi),%xmm7
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab7six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab7six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t7 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t7=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t7=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t13=int6464#8
# asm 2: mulpd 96(<op2=%rdx),<1t13=%xmm7
mulpd 96(%rdx),%xmm7
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t8=int6464#8
# asm 2: mulpd 16(<op2=%rdx),<0t8=%xmm7
mulpd 16(%rdx),%xmm7
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t9=int6464#8
# asm 2: mulpd 32(<op2=%rdx),<0t9=%xmm7
mulpd 32(%rdx),%xmm7
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t10=int6464#8
# asm 2: mulpd 48(<op2=%rdx),<0t10=%xmm7
mulpd 48(%rdx),%xmm7
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<0t11=int6464#8
# asm 2: mulpd 64(<op2=%rdx),<0t11=%xmm7
mulpd 64(%rdx),%xmm7
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<1t12=int6464#8
# asm 2: mulpd 80(<op2=%rdx),<1t12=%xmm7
mulpd 80(%rdx),%xmm7
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t14=int6464#8
# asm 2: mulpd 112(<op2=%rdx),<1t14=%xmm7
mulpd 112(%rdx),%xmm7
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t15=int6464#8
# asm 2: mulpd 128(<op2=%rdx),<1t15=%xmm7
mulpd 128(%rdx),%xmm7
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t16=int6464#8
# asm 2: mulpd 144(<op2=%rdx),<1t16=%xmm7
mulpd 144(%rdx),%xmm7
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t17=int6464#8
# asm 2: mulpd 160(<op2=%rdx),<1t17=%xmm7
mulpd 160(%rdx),%xmm7
...
# qhasm: float6464 1t18 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t18=int6464#8
# asm 2: mulpd 176(<op2=%rdx),<1t18=%xmm7
mulpd 176(%rdx),%xmm7
...
# qhasm: *(int128 *)(0mysp + 112) = 0r7
# asm 1: movdqa <0r7=int6464#9,112(<0mysp=int64#4)
# asm 2: movdqa <0r7=%xmm8,112(<0mysp=%rcx)
movdqa %xmm8,112(%rcx)

# qhasm: 0ab8 = *(int128 *)(op1 + 128)
# asm 1: movdqa 128(<op1=int64#2),>0ab8=int6464#9
# asm 2: movdqa 128(<op1=%rsi),>0ab8=%xmm8
movdqa 128(%rsi),%xmm8
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab8six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab8six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t8 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t8=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t8=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<1t13=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<1t14=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t19 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t19=int6464#9
# asm 2: mulpd 176(<op2=%rdx),<1t19=%xmm8
mulpd 176(%rdx),%xmm8
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t9=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t10=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<0t11=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<1t12=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<1t12=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t15=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<1t15=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t16=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<1t16=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t17=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<1t17=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t18 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t18=int6464#13
# asm 2: mulpd 160(<op2=%rdx),<1t18=%xmm12
mulpd 160(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 128) = 0r8
# asm 1: movdqa <0r8=int6464#10,128(<0mysp=int64#4)
# asm 2: movdqa <0r8=%xmm9,128(<0mysp=%rcx)
movdqa %xmm9,128(%rcx)

# qhasm: 0ab9 = *(int128 *)(op1 + 144)
# asm 1: movdqa 144(<op1=int64#2),>0ab9=int6464#10
# asm 2: movdqa 144(<op1=%rsi),>0ab9=%xmm9
movdqa 144(%rsi),%xmm9
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab9six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab9six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t9 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t9=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t9=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<1t13=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<1t14=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t15=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<1t15=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t19 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t19=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t19=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t20 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t20=int6464#10
# asm 2: mulpd 176(<op2=%rdx),<1t20=%xmm9
mulpd 176(%rdx),%xmm9
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t10=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<0t11=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<1t12=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<1t12=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t16=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<1t16=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t17=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<1t17=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 1t18 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t18=int6464#13
# asm 2: mulpd 144(<op2=%rdx),<1t18=%xmm12
mulpd 144(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 144) = 0r9
# asm 1: movdqa <0r9=int6464#11,144(<0mysp=int64#4)
# asm 2: movdqa <0r9=%xmm10,144(<0mysp=%rcx)
movdqa %xmm10,144(%rcx)

# qhasm: 0ab10 = *(int128 *)(op1 + 160)
# asm 1: movdqa 160(<op1=int64#2),>0ab10=int6464#11
# asm 2: movdqa 160(<op1=%rsi),>0ab10=%xmm10
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab10six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab10six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t10 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t10=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t10=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<1t13=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<1t14=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t16=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<1t16=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<1t15=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<1t15=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 1t19 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t19=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<1t19=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t20 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t20=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t20=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t21 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t21=int6464#11
# asm 2: mulpd 176(<op2=%rdx),<1t21=%xmm10
mulpd 176(%rdx),%xmm10
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<0t11=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<1t12=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<1t12=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t17=int6464#14
# asm 2: mulpd 112(<op2=%rdx),<1t17=%xmm13
mulpd 112(%rdx),%xmm13
...
# qhasm: float6464 1t18 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t18=int6464#13
# asm 2: mulpd 128(<op2=%rdx),<1t18=%xmm12
mulpd 128(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 160) = 0r10
# asm 1: movdqa <0r10=int6464#12,160(<0mysp=int64#4)
# asm 2: movdqa <0r10=%xmm11,160(<0mysp=%rcx)
movdqa %xmm11,160(%rcx)

# qhasm: 0ab11 = *(int128 *)(op1 + 176)
# asm 1: movdqa 176(<op1=int64#2),>0ab11=int6464#12
# asm 2: movdqa 176(<op1=%rsi),>0ab11=%xmm11
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<0ab11six=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<0ab11six=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: float6464 0t11 *= *(int128 *)(op2 + 0)
# asm 1: mulpd 0(<op2=int64#3),<0t11=int6464#14
# asm 2: mulpd 0(<op2=%rdx),<0t11=%xmm13
mulpd 0(%rdx),%xmm13
...
# qhasm: float6464 1t13 *= *(int128 *)(op2 + 32)
# asm 1: mulpd 32(<op2=int64#3),<1t13=int6464#14
# asm 2: mulpd 32(<op2=%rdx),<1t13=%xmm13
mulpd 32(%rdx),%xmm13
...
# qhasm: float6464 1t14 *= *(int128 *)(op2 + 48)
# asm 1: mulpd 48(<op2=int64#3),<1t14=int6464#14
# asm 2: mulpd 48(<op2=%rdx),<1t14=%xmm13
mulpd 48(%rdx),%xmm13
...
# qhasm: float6464 1t15 *= *(int128 *)(op2 + 64)
# asm 1: mulpd 64(<op2=int64#3),<1t15=int6464#14
# asm 2: mulpd 64(<op2=%rdx),<1t15=%xmm13
mulpd 64(%rdx),%xmm13
...
# qhasm: float6464 1t16 *= *(int128 *)(op2 + 80)
# asm 1: mulpd 80(<op2=int64#3),<1t16=int6464#14
# asm 2: mulpd 80(<op2=%rdx),<1t16=%xmm13
mulpd 80(%rdx),%xmm13
...
# qhasm: float6464 1t17 *= *(int128 *)(op2 + 96)
# asm 1: mulpd 96(<op2=int64#3),<1t17=int6464#14
# asm 2: mulpd 96(<op2=%rdx),<1t17=%xmm13
mulpd 96(%rdx),%xmm13
...
# qhasm: float6464 1t19 *= *(int128 *)(op2 + 128)
# asm 1: mulpd 128(<op2=int64#3),<1t19=int6464#14
# asm 2: mulpd 128(<op2=%rdx),<1t19=%xmm13
mulpd 128(%rdx),%xmm13
...
# qhasm: float6464 1t20 *= *(int128 *)(op2 + 144)
# asm 1: mulpd 144(<op2=int64#3),<1t20=int6464#14
# asm 2: mulpd 144(<op2=%rdx),<1t20=%xmm13
mulpd 144(%rdx),%xmm13
...
# qhasm: float6464 1t21 *= *(int128 *)(op2 + 160)
# asm 1: mulpd 160(<op2=int64#3),<1t21=int6464#14
# asm 2: mulpd 160(<op2=%rdx),<1t21=%xmm13
mulpd 160(%rdx),%xmm13
...
# qhasm: float6464 1t22 *= *(int128 *)(op2 + 176)
# asm 1: mulpd 176(<op2=int64#3),<1t22=int6464#12
# asm 2: mulpd 176(<op2=%rdx),<1t22=%xmm11
mulpd 176(%rdx),%xmm11
...
# qhasm: float6464 1t12 *= *(int128 *)(op2 + 16)
# asm 1: mulpd 16(<op2=int64#3),<1t12=int6464#14
# asm 2: mulpd 16(<op2=%rdx),<1t12=%xmm13
mulpd 16(%rdx),%xmm13
...
# qhasm: float6464 1t18 *= *(int128 *)(op2 + 112)
# asm 1: mulpd 112(<op2=int64#3),<1t18=int6464#13
# asm 2: mulpd 112(<op2=%rdx),<1t18=%xmm12
mulpd 112(%rdx),%xmm12
...
# qhasm: *(int128 *)(0mysp + 176) = 0r11
# asm 1: movdqa <0r11=int6464#1,176(<0mysp=int64#4)
# asm 2: movdqa <0r11=%xmm0,176(<0mysp=%rcx)
movdqa %xmm0,176(%rcx)
...
# qhasm: 1r0 = *(int128 *)(0mysp + 0)
# asm 1: movdqa 0(<0mysp=int64#4),>1r0=int6464#1
# asm 2: movdqa 0(<0mysp=%rcx),>1r0=%xmm0
movdqa 0(%rcx),%xmm0
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t15=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t15=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t18=int6464#13
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t18=%xmm12
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t21=int6464#13
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t21=%xmm12
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm12
...
# qhasm: *(int128 *)(0mysp + 0) = 1r0
# asm 1: movdqa <1r0=int6464#1,0(<0mysp=int64#4)
# asm 2: movdqa <1r0=%xmm0,0(<0mysp=%rcx)
movdqa %xmm0,0(%rcx)

# qhasm: 1r3 = *(int128 *)(0mysp + 48)
# asm 1: movdqa 48(<0mysp=int64#4),>1r3=int6464#1
# asm 2: movdqa 48(<0mysp=%rcx),>1r3=%xmm0
movdqa 48(%rcx),%xmm0
...
# asm 1: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t15=int6464#13
# asm 2: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t15=%xmm12
...
# asm 1: mulpd EIGHT_EIGHT@GOTPCREL(%rip),<2t21=int6464#13
# asm 2: mulpd EIGHT_EIGHT@GOTPCREL(%rip),<2t21=%xmm12
...
# qhasm: *(int128 *)(0mysp + 48) = 1r3
# asm 1: movdqa <1r3=int6464#1,48(<0mysp=int64#4)
# asm 2: movdqa <1r3=%xmm0,48(<0mysp=%rcx)
movdqa %xmm0,48(%rcx)

# qhasm: 1r6 = *(int128 *)(0mysp + 96)
# asm 1: movdqa 96(<0mysp=int64#4),>1r6=int6464#1
# asm 2: movdqa 96(<0mysp=%rcx),>1r6=%xmm0
movdqa 96(%rcx),%xmm0
...
# asm 1: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t12=int6464#13
# asm 2: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t12=%xmm12
...
# asm 1: mulpd EIGHTEEN_EIGHTEEN@GOTPCREL(%rip),<2t15=int6464#13
# asm 2: mulpd EIGHTEEN_EIGHTEEN@GOTPCREL(%rip),<2t15=%xmm12
...
# asm 1: mulpd THREE_THREE@GOTPCREL(%rip),<2t18=int6464#13
# asm 2: mulpd THREE_THREE@GOTPCREL(%rip),<2t18=%xmm12
...
# asm 1: mulpd THIRTY_THIRTY@GOTPCREL(%rip),<2t21=int6464#13
# asm 2: mulpd THIRTY_THIRTY@GOTPCREL(%rip),<2t21=%xmm12
...
# qhasm: *(int128 *)(0mysp + 96) = 1r6
# asm 1: movdqa <1r6=int6464#1,96(<0mysp=int64#4)
# asm 2: movdqa <1r6=%xmm0,96(<0mysp=%rcx)
movdqa %xmm0,96(%rcx)

# qhasm: 1r9 = *(int128 *)(0mysp + 144)
# asm 1: movdqa 144(<0mysp=int64#4),>1r9=int6464#1
# asm 2: movdqa 144(<0mysp=%rcx),>1r9=%xmm0
movdqa 144(%rcx),%xmm0
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t15=int6464#2
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t15=%xmm1
mov TWO_TWO@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd NINE_NINE@GOTPCREL(%rip),<2t21=int6464#2
# asm 2: mulpd NINE_NINE@GOTPCREL(%rip),<2t21=%xmm1
...
# qhasm: *(int128 *)(0mysp + 144) = 1r9
# asm 1: movdqa <1r9=int6464#1,144(<0mysp=int64#4)
# asm 2: movdqa <1r9=%xmm0,144(<0mysp=%rcx)
movdqa %xmm0,144(%rcx)

# qhasm: 1r1 = *(int128 *)(0mysp + 16)
# asm 1: movdqa 16(<0mysp=int64#4),>1r1=int6464#1
# asm 2: movdqa 16(<0mysp=%rcx),>1r1=%xmm0
movdqa 16(%rcx),%xmm0
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t19=int6464#2
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t19=%xmm1
mov TWO_TWO@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 16) = 1r1
# asm 1: movdqa <1r1=int6464#1,16(<0mysp=int64#4)
# asm 2: movdqa <1r1=%xmm0,16(<0mysp=%rcx)
movdqa %xmm0,16(%rcx)

# qhasm: 1r4 = *(int128 *)(0mysp + 64)
# asm 1: movdqa 64(<0mysp=int64#4),>1r4=int6464#1
# asm 2: movdqa 64(<0mysp=%rcx),>1r4=%xmm0
movdqa 64(%rcx),%xmm0
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t13=int6464#2
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t13=%xmm1
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t16=int6464#2
# asm 2: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t16=%xmm1
mov FIVE_FIVE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t19=int6464#2
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t19=%xmm1
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd EIGHT_EIGHT@GOTPCREL(%rip),<2t22=int6464#2
# asm 2: mulpd EIGHT_EIGHT@GOTPCREL(%rip),<2t22=%xmm1
mov EIGHT_EIGHT@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 64) = 1r4
# asm 1: movdqa <1r4=int6464#1,64(<0mysp=int64#4)
# asm 2: movdqa <1r4=%xmm0,64(<0mysp=%rcx)
movdqa %xmm0,64(%rcx)

# qhasm: 1r7 = *(int128 *)(0mysp + 112)
# asm 1: movdqa 112(<0mysp=int64#4),>1r7=int6464#1
# asm 2: movdqa 112(<0mysp=%rcx),>1r7=%xmm0
movdqa 112(%rcx),%xmm0
...
# asm 1: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t13=int6464#2
# asm 2: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t13=%xmm1
mov FOUR_FOUR@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd THREE_THREE@GOTPCREL(%rip),<2t16=int6464#2
# asm 2: mulpd THREE_THREE@GOTPCREL(%rip),<2t16=%xmm1
mov THREE_THREE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd THREE_THREE@GOTPCREL(%rip),<2t19=int6464#2
# asm 2: mulpd THREE_THREE@GOTPCREL(%rip),<2t19=%xmm1
mov THREE_THREE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t22=int6464#2
# asm 2: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t22=%xmm1
mov FIVE_FIVE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 112) = 1r7
# asm 1: movdqa <1r7=int6464#1,112(<0mysp=int64#4)
# asm 2: movdqa <1r7=%xmm0,112(<0mysp=%rcx)
movdqa %xmm0,112(%rcx)

# qhasm: 1r10 = *(int128 *)(0mysp + 160)
# asm 1: movdqa 160(<0mysp=int64#4),>1r10=int6464#1
# asm 2: movdqa 160(<0mysp=%rcx),>1r10=%xmm0
movdqa 160(%rcx),%xmm0
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t16=int6464#2
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t16=%xmm1
mov TWO_TWO@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd NINE_NINE@GOTPCREL(%rip),<2t22=int6464#2
# asm 2: mulpd NINE_NINE@GOTPCREL(%rip),<2t22=%xmm1
mov NINE_NINE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 160) = 1r10
# asm 1: movdqa <1r10=int6464#1,160(<0mysp=int64#4)
# asm 2: movdqa <1r10=%xmm0,160(<0mysp=%rcx)
movdqa %xmm0,160(%rcx)

# qhasm: 1r2 = *(int128 *)(0mysp + 32)
# asm 1: movdqa 32(<0mysp=int64#4),>1r2=int6464#1
# asm 2: movdqa 32(<0mysp=%rcx),>1r2=%xmm0
movdqa 32(%rcx),%xmm0
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t20=int6464#2
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t20=%xmm1
mov TWO_TWO@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 32) = 1r2
# asm 1: movdqa <1r2=int6464#1,32(<0mysp=int64#4)
# asm 2: movdqa <1r2=%xmm0,32(<0mysp=%rcx)
movdqa %xmm0,32(%rcx)

# qhasm: 1r5 = *(int128 *)(0mysp + 80)
# asm 1: movdqa 80(<0mysp=int64#4),>1r5=int6464#1
# asm 2: movdqa 80(<0mysp=%rcx),>1r5=%xmm0
movdqa 80(%rcx),%xmm0
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t14=int6464#2
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t14=%xmm1
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t17=int6464#2
# asm 2: mulpd FIVE_FIVE@GOTPCREL(%rip),<2t17=%xmm1
mov FIVE_FIVE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd SIX_SIX@GOTPCREL(%rip),<2t20=int6464#2
# asm 2: mulpd SIX_SIX@GOTPCREL(%rip),<2t20=%xmm1
mov SIX_SIX@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 80) = 1r5
# asm 1: movdqa <1r5=int6464#1,80(<0mysp=int64#4)
# asm 2: movdqa <1r5=%xmm0,80(<0mysp=%rcx)
movdqa %xmm0,80(%rcx)

# qhasm: 1r8 = *(int128 *)(0mysp + 128)
# asm 1: movdqa 128(<0mysp=int64#4),>1r8=int6464#1
# asm 2: movdqa 128(<0mysp=%rcx),>1r8=%xmm0
movdqa 128(%rcx),%xmm0
...
# asm 1: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t14=int6464#2
# asm 2: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t14=%xmm1
mov FOUR_FOUR@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd THREE_THREE@GOTPCREL(%rip),<2t17=int6464#2
# asm 2: mulpd THREE_THREE@GOTPCREL(%rip),<2t17=%xmm1
mov THREE_THREE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# asm 1: mulpd THREE_THREE@GOTPCREL(%rip),<2t20=int6464#2
# asm 2: mulpd THREE_THREE@GOTPCREL(%rip),<2t20=%xmm1
mov THREE_THREE@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 128) = 1r8
# asm 1: movdqa <1r8=int6464#1,128(<0mysp=int64#4)
# asm 2: movdqa <1r8=%xmm0,128(<0mysp=%rcx)
movdqa %xmm0,128(%rcx)

# qhasm: 1r11 = *(int128 *)(0mysp + 176)
# asm 1: movdqa 176(<0mysp=int64#4),>1r11=int6464#1
# asm 2: movdqa 176(<0mysp=%rcx),>1r11=%xmm0
movdqa 176(%rcx),%xmm0
...
# asm 1: mulpd TWO_TWO@GOTPCREL(%rip),<2t17=int6464#2
# asm 2: mulpd TWO_TWO@GOTPCREL(%rip),<2t17=%xmm1
mov TWO_TWO@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm1
...
# qhasm: *(int128 *)(0mysp + 176) = 1r11
# asm 1: movdqa <1r11=int6464#1,176(<0mysp=int64#4)
# asm 2: movdqa <1r11=%xmm0,176(<0mysp=%rcx)
movdqa %xmm0,176(%rcx)
...
# qhasm: r0 = *(int128 *)(0mysp + 0)
# asm 1: movdqa 0(<0mysp=int64#4),>r0=int6464#1
# asm 2: movdqa 0(<0mysp=%rcx),>r0=%xmm0
movdqa 0(%rcx),%xmm0

# qhasm: r1 = *(int128 *)(0mysp + 16)
# asm 1: movdqa 16(<0mysp=int64#4),>r1=int6464#2
# asm 2: movdqa 16(<0mysp=%rcx),>r1=%xmm1
movdqa 16(%rcx),%xmm1

# qhasm: r2 = *(int128 *)(0mysp + 32)
# asm 1: movdqa 32(<0mysp=int64#4),>r2=int6464#3
# asm 2: movdqa 32(<0mysp=%rcx),>r2=%xmm2
movdqa 32(%rcx),%xmm2

# qhasm: r3 = *(int128 *)(0mysp + 48)
# asm 1: movdqa 48(<0mysp=int64#4),>r3=int6464#4
# asm 2: movdqa 48(<0mysp=%rcx),>r3=%xmm3
movdqa 48(%rcx),%xmm3

# qhasm: r4 = *(int128 *)(0mysp + 64)
# asm 1: movdqa 64(<0mysp=int64#4),>r4=int6464#5
# asm 2: movdqa 64(<0mysp=%rcx),>r4=%xmm4
movdqa 64(%rcx),%xmm4

# qhasm: r5 = *(int128 *)(0mysp + 80)
# asm 1: movdqa 80(<0mysp=int64#4),>r5=int6464#6
# asm 2: movdqa 80(<0mysp=%rcx),>r5=%xmm5
movdqa 80(%rcx),%xmm5

# qhasm: r6 = *(int128 *)(0mysp + 96)
# asm 1: movdqa 96(<0mysp=int64#4),>r6=int6464#7
# asm 2: movdqa 96(<0mysp=%rcx),>r6=%xmm6
movdqa 96(%rcx),%xmm6

# qhasm: r7 = *(int128 *)(0mysp + 112)
# asm 1: movdqa 112(<0mysp=int64#4),>r7=int6464#8
# asm 2: movdqa 112(<0mysp=%rcx),>r7=%xmm7
movdqa 112(%rcx),%xmm7

# qhasm: r8 = *(int128 *)(0mysp + 128)
# asm 1: movdqa 128(<0mysp=int64#4),>r8=int6464#9
# asm 2: movdqa 128(<0mysp=%rcx),>r8=%xmm8
movdqa 128(%rcx),%xmm8

# qhasm: r9 = *(int128 *)(0mysp + 144)
# asm 1: movdqa 144(<0mysp=int64#4),>r9=int6464#10
# asm 2: movdqa 144(<0mysp=%rcx),>r9=%xmm9
movdqa 144(%rcx),%xmm9

# qhasm: r10 = *(int128 *)(0mysp + 160)
# asm 1: movdqa 160(<0mysp=int64#4),>r10=int6464#11
# asm 2: movdqa 160(<0mysp=%rcx),>r10=%xmm10
movdqa 160(%rcx),%xmm10

# qhasm: r11 = *(int128 *)(0mysp + 176)
# asm 1: movdqa 176(<0mysp=int64#4),>r11=int6464#12
# asm 2: movdqa 176(<0mysp=%rcx),>r11=%xmm11
movdqa 176(%rcx),%xmm11

# qhasm: 0round = ROUND_ROUND
# asm 1: movdqa ROUND_ROUND@GOTPCREL(%rip),<0round=int6464#13
# asm 2: movdqa ROUND_ROUND@GOTPCREL(%rip),<0round=%xmm12
...
# asm 1: mulpd VINV_VINV@GOTPCREL(%rip),<0carry=int6464#14
# asm 2: mulpd VINV_VINV@GOTPCREL(%rip),<0carry=%xmm13
...
# asm 1: mulpd V_V@GOTPCREL(%rip),<0carry=int6464#14
# asm 2: mulpd V_V@GOTPCREL(%rip),<0carry=%xmm13
...
# asm 1: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t6=int6464#15
# asm 2: mulpd FOUR_FOUR@GOTPCREL(%rip),<2t6=%xmm14
mov FOUR_FOUR@GOTPCREL(%rip), %rbp
mulpd (%rbp),%xmm14
...
# asm 1: mulpd V6INV_V6INV@GOTPCREL(%rip),<0carry=int6464#14
# asm 2: mulpd V6INV_V6INV@GOTPCREL(%rip),<0carry=%xmm13
...
# asm 1: mulpd V6_V6@GOTPCREL(%rip),<0carry=int6464#14
# asm 2: mulpd V6_V6@GOTPCREL(%rip),<0carry=%xmm13
